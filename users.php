...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/logo 1.jpg" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money
                Transfer</strong> <img src="logos/logo 4.png" alt="Bank" width="75" height="75">
        </h2>
    </class>
