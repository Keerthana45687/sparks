...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        ...
        <a class="navbar-brand" href="#">SPARKS BANK <img src="logos/logo 1.jpg" alt="Bank" width="50" height="50"></a>
...
<class class="welcome">
        <h2>
            <img src="logos/logo 1.jpg" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong> <img
                src="logos/logo 2.png" alt="Bank" width="75" height="75">
        </h2>
    </class>
